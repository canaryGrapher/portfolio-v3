...
import { PhotosFooter, PhotosContent } from '@/components/pages/photos';
            ...
            <div className="max-w-7xl mx-auto px-4">
                ...
                <div className="pt-16 pb-10">
                    ...
                    <h1 className="text-4xl sm:text-5xl md:text-7xl font-extrabold tracking-tight text-gray-900 mb-5 max-w-4xl leading-[1.1]">
                        Capturing moments that <span className="text-transparent bg-clip-text bg-gradient-to-r from-green-800 via-emerald-705 to-teal-900">tell stories.</span>
                    </h1>
                    
                    {/* Subtitle description */}
                    <p className="text-sm sm:text-base md:text-lg text-gray-600 max-w-3xl leading-relaxed font-semibold">
                        A curated showcase of street photography, architecture, and landscapes. Documenting places, perspectives, and fleeting instances through different lenses.
                    </p>
                </div>
