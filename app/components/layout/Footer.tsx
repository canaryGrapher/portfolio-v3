      ...
      <div className="grid grid-cols-1 md:grid-cols-5 max-w-7xl mx-auto items-start lg:items-center min-h-[200px]">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center md:justify-start space-x-3 col-span-5 md:col-span-1">
          ...
          <div className="text-center md:text-left"> 
            <h3 className="font-bold text-white text-lg">{HeroSectionData.name}</h3>
            <p className="text-white text-sm">{HeroSectionData.title.join('. ')}</p>
          </div>
        </div>

        {/* Motivational Quote Section */}
        <div className="flex-1 flex justify-center col-span-5 md:col-span-2 px-10 md:px-20 my-5 md:my-0">
          <blockquote className="text-gray-300 text-center md:text-left italic max-w-md">
            &quot;{FooterData.quote}&quot;
          </blockquote>
        </div>

        {/* Links Section */}
        <div className="flex flex-col-reverse md:flex-row justify-evenly md:justify-around space-x-8 col-span-5 md:col-span-2 px-10 md:px-20">
