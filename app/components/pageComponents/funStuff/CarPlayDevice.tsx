...
const CarPlayDevice = forwardRef<HTMLDivElement, CarPlayDeviceProps>(
    ({ className = "", icons }, ref) => {
        return (
            <div ref={ref} className={`my-10 mx-auto w-full min-h-[500px] h-full bg-black/20 backdrop-blur-xl rounded-[20px] border border-white/20 flex flex-row-reverse justify-between relative ${className}`}>
                {/* Status Bar */}
                <div className="flex flex-col justify-between bg-white/40 backdrop-blur-xl rounded-tr-[20px] rounded-br-[20px] w-[80px]">
                ...
                {/* App Grid */}
                <div className="grid grid-cols-5 gap-5 p-18">
