...
const RelatedWorkCard: React.FC<RelatedWorkCardProps> = ({
    ...
    return (
        <div className="relative h-80 overflow-hidden group transition-all duration-300 hover:border-transparent hover:shadow-[0_0_10px_rgba(255,255,255,0.6)] hover:shadow-indigo-500/50">
            {/* Background Image */}
