    ...
    return (
        ...
        >
            <div>
                ...
                <span className={dateClasses}>{formatDateRange(project.startDate, project.endDate)}</span>
            ...
            {project.associatedWith && (
                <div className={companyClasses}>
                    <p>Associated with <span className="font-bold">{project.associatedWith}</span></p>
                </div>
            )}
        </div>
    );
